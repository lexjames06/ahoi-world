...
// Load font
const interBoldP = fetch(new URL(`${BASE_URL}/fonts/Inter-Bold.ttf`, import.meta.url))
			...
			(
				...
				>
					...
					>
						...
						<span
							style={{ display: "flex", width: "100%", height: "5px", backgroundColor: green, margin: "1rem 0" }}
						></span>
						<h2
							style={{
								color: "#fff",
						...
						>
							{subtext}
							<span style={{ display: "flex", color: green, marginLeft: "0.75rem" }}>{username}</span>
						</h2>
					</div>
